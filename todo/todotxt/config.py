...
KEYBINDINGS = [
    ...
    ("tab / shift+tab", "Move to the next / previous section (list, detail, search)", "Navigation"),
    ("n", "New task", "Tasks"),
    ...
    ("d", "Delete task", "Tasks"),
    ("y", "Copy the task, or the whole project under the cursor", "Tasks"),
    ("Y", "Copy the whole list as it is filtered", "Tasks"),
